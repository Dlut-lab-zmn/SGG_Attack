...
if __name__ == "__main__":
    ...
    # model_msdn.train()
    model_grcnn.train()
    model_ls = [model_grcnn, model_ind]#model_mn2, model_mn3, model_ind]#model_nm,model_reldn, model_imp, model_msdn, model_grcnn
    ...
    with alive_bar(len(data_loaders_val)) as bar:
        for iteration, data_batch in enumerate(data_loaders_val):
            ...
            if  FLAG:
                ...
                # is_ob_attack = False
                # print(is_ob_attack, is_relation_attack)
                if is_ob_attack:
                    is_success, attack_record, ob_prop , proposals_pairs = gm_attack(images, (targets,current_targets), normal,model_ls,
                                                                                                                                                    ...
                                                                                                                                                    steps=1, epsilon_steps=1, is_validate = True,
